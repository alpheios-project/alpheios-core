  ...
  production: {
    ...
    resolve: {
      alias: {
        ...
        'alpheios-wordlist': path.join(projectRoot, 'node_modules/alpheios-wordlist-next/dist/alpheios-wordlist.min.js'),
  ...
  development: {
    ...
    resolve: {
      alias: {
        ...
        'alpheios-wordlist': path.join(projectRoot, 'node_modules/alpheios-wordlist-next/dist/alpheios-wordlist.js'),
