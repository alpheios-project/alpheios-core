...
import OverlayNavModule from '@/vue/vuex-modules/ui/overlay-nav-module.js'
...
export { Popup, PopupMobile, Panel, L10n, Locales, enUS, enGB, UIController, UIEventController,
  ...
  HTMLPage, Tab, TabScript, L10nModule, AuthModule, PanelModule, PopupModule, OverlayNavModule }
