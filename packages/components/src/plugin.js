...
import TabScript from '@comp-src/lib/state/tab-script.js'
import L10nModule from '@comp-src/vue/vuex-modules/data/l10n-module.js'
import AuthModule from '@comp-src/vue/vuex-modules/data/auth-module.js'
import PanelModule from '@comp-src/vue/vuex-modules/ui/panel-module.js'
import PopupModule from '@comp-src/vue/vuex-modules/ui/popup-module.js'
import ToolbarModule from '@comp-src/vue/vuex-modules/ui/toolbar-module.js'
import ActionPanelModule from '@comp-src/vue/vuex-modules/ui/action-panel-module.js'
