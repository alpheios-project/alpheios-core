<template>
    <div class="alpheios-ib">
        ...
        <div v-if="!collapsed[constants.LANG_LATIN.toString()]">
            ...
            <wide-table :view="latinInflView({ viewID: 'latin_conjugation_mood_voice_view', title: 'Regular Verb (conjugation-mood-voice)' })" :infl-browser-table="true" :messages="messages" :no-suffix-matches-hidden="false" :collapsed="inflBrowserTablesCollapsed" @widthchange="inflTableWidthUpd" @interaction="inflTableInteraction"></wide-table>
            <wide-table :view="latinInflView({ viewID: 'latin_conjugation_voice_mood_view', title: 'Regular Verb (conjugation-voice-mood)' })" :infl-browser-table="true" :messages="messages" :no-suffix-matches-hidden="false" :collapsed="inflBrowserTablesCollapsed" @widthchange="inflTableWidthUpd" @interaction="inflTableInteraction"></wide-table>
            <wide-table :view="latinInflView({ viewID: 'latin_mood_conjugation_voice_view', title: 'Regular Verb (mood-conjugation-voice)' })" :infl-browser-table="true" :messages="messages" :no-suffix-matches-hidden="false" :collapsed="inflBrowserTablesCollapsed" @widthchange="inflTableWidthUpd" @interaction="inflTableInteraction"></wide-table>
            <wide-table :view="latinInflView({ viewID: 'latin_mood_voice_conjugation_view', title: 'Regular Verb (mood-voice-conjugation)' })" :infl-browser-table="true" :messages="messages" :no-suffix-matches-hidden="false" :collapsed="inflBrowserTablesCollapsed" @widthchange="inflTableWidthUpd" @interaction="inflTableInteraction"></wide-table>
            <wide-table :view="latinInflView({ viewID: 'latin_voice_conjugation_mood_view', title: 'Regular Verb (voice-conjugation-mood)' })" :infl-browser-table="true" :messages="messages" :no-suffix-matches-hidden="false" :collapsed="inflBrowserTablesCollapsed" @widthchange="inflTableWidthUpd" @interaction="inflTableInteraction"></wide-table>
            <wide-table :view="latinInflView({ viewID: 'latin_voice_mood_conjugation_view', title: 'Regular Verb (voice-mood-conjugation)' })" :infl-browser-table="true" :messages="messages" :no-suffix-matches-hidden="false" :collapsed="inflBrowserTablesCollapsed" @widthchange="inflTableWidthUpd" @interaction="inflTableInteraction"></wide-table>
