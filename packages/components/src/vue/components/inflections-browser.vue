  ...
  <div class="alpheios-ib">
    ...
    <div v-show="!collapsed[constants.LANG_GREEK.toString()]">
      ...
      <wide-table :collapsed="inflBrowserTablesCollapsed" :infl-browser-table="true"
                  ...
                  @widthchange="inflTableWidthUpd"></wide-table>
      <wide-table :collapsed="inflBrowserTablesCollapsed" :infl-browser-table="true"
                  :no-suffix-matches-hidden="false" :view="greekInflView({ viewID: 'greek_adjective_simplified_view'})"
                  @widthchange="inflTableWidthUpd"></wide-table>
      ...
      <wide-table :collapsed="inflBrowserTablesCollapsed" :infl-browser-table="true"
                  :no-suffix-matches-hidden="false" :view="greekInflView({ viewID: 'greek_article_view', form: 'τοῦ' })"
                  @widthchange="inflTableWidthUpd"></wide-table>
      <div class="alpheios-ib__pofs-title">Numerals</div>
      <wide-table :collapsed="inflBrowserTablesCollapsed" :infl-browser-table="true"
                  :no-suffix-matches-hidden="false" :view="greekInflView({ viewID: 'greek_numeral_view', form: 'δύο' })"
                  @widthchange="inflTableWidthUpd"></wide-table>
