    ...
    <div class="alpheios-morph__inflections" v-if="inflections.length >0">
      <div class="alpheios-morph__inflset" v-for="(inflset, ifindex) in inflection">
        <div class="alpheios-morph__forms">
          <span class="alpheios-morph__formtext alpheios-text__large" data-feature="prefix" data-grouplevel="1"
                v-if="inflset.groupingKey.prefix">{{inflset.groupingKey.prefix}} </span>
          <span class="alpheios-morph__formtext alpheios-text__large" data-feature="stem" data-grouplevel="1">{{inflset.groupingKey.stem}}</span>
          <span class="alpheios-morph__formtext alpheios-text__large" data-feature="suffix" data-grouplevel="1"
    ...
    <div class="alpheios-morph__features">
      ...
      <span>
        <span :lang="languageCode(lex.lemma.languageID)"
              class="alpheios-morph__hdwd alpheios-morph__formtext alpheios-morph__groupitem alpheios-text__large"
