<template>
  <div class="alpheios-morph">
    <annotation-area :annotation-mode="$store.state.app.isInAnnotationMode">
      <div
          :key="lex.lemma.ID"
...
import { AnnotationArea, AnnotationLemma } from 'alpheios-annotations'
// Modules support
...
export default {
  ...
  components: {
    ...
    annotationLemma: AnnotationLemma
  },
  inject: ['app', 'l10n'],
  storeModules: ['app'],
