...
/*! export L10n [provided] [maybe used (runtime-defined)] [usage prevents renaming] */
...
/*! export MessageBundle [provided] [maybe used (runtime-defined)] [usage prevents renaming] */
...
/* harmony export */   "L10n": () => /* reexport safe */ _l10n_l10n_js__WEBPACK_IMPORTED_MODULE_33__.default,
/* harmony export */   "MessageBundle": () => /* reexport safe */ _l10n_message_bundle_js__WEBPACK_IMPORTED_MODULE_34__.default
/* harmony export */ });
...
/* harmony import */ var _l10n_l10n_js__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./l10n/l10n.js */ "./l10n/l10n.js");
/* harmony import */ var _l10n_message_bundle_js__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./l10n/message-bundle.js */ "./l10n/message-bundle.js");
...
class L10n {
  ...
  addMessages (messageJSON, locale, missingTranslationMsgFn) {
    ...
    if (this.bundles.has(locale)) {
      ...
      messageBundle = new _message_bundle__WEBPACK_IMPORTED_MODULE_0__.default(messageJSON, locale, missingTranslationMsgFn)
...
class Message {
  ...
  constructor (message, locale) {
    ...
    this.formatFunc = new intl_messageformat__WEBPACK_IMPORTED_MODULE_1__.default(this.message, this.locale)
    this.abbrFunc = new intl_messageformat__WEBPACK_IMPORTED_MODULE_1__.default(this.abbr || this.message, this.locale)
  }
  ...
  getMsg (formatOptions) {
    if (this.hasParameters && !this.formatFunc) {
      _logging_logger_js__WEBPACK_IMPORTED_MODULE_0__.default.getInstance().warn(`Format function is missing for a message with parameters: ${this.message}`, this.params)
