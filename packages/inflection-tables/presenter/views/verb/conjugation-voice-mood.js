...
view.id = 'verbConjugationVoiceMood';
view.name = 'verb conjugation-voice-mood';
view.title = 'Conjugation-Voice-Mood';
...
view.groupingFeatures = [conjugations, voices, moods, tenses, numbers, persons];
