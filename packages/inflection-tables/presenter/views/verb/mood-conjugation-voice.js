...
view.id = 'verbMoodConjugationVoice';
view.name = 'verb mood-conjugation-voice';
view.title = 'Mood-Conjugation-Voice';
...
view.groupingFeatures = [moods, conjugations, voices, tenses, numbers, persons];
