...
view.id = 'verbMoodVoiceConjugation';
view.name = 'verb mood-voice-conjugation';
view.title = 'Mood-Voice-Conjugation';
...
view.groupingFeatures = [moods, voices, conjugations, tenses, numbers, persons];
