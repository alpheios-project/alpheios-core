...
view.id = 'verbVoiceMoodConjugation';
view.name = 'verb voice-mood-conjugation';
view.title = 'Voice-Mood-Conjugation';
...
view.groupingFeatures = [voices, moods, conjugations, tenses, numbers, persons];
