 ...
 */
import { Constants, Feature, FeatureImporter, Lemma } from '@alpheios-core/data-models'
import LanguageDataset from '@lib/language-dataset.js'
import Suffix from '@lib/suffix.js'
import Form from '@lib/form.js'
// import ComparisonFeature from '@lib/comparison-feature.js'
import nounSuffixesCSV from '@lib/lang/latin/data/noun/suffixes.csv?raw'
import nounFootnotesCSV from '@lib/lang/latin/data/noun/footnotes.csv?raw'
import pronounFormsCSV from '@lib/lang/latin/data/pronoun/forms.csv?raw'
import pronounFootnotesCSV from '@lib/lang/latin/data/pronoun/footnotes.csv?raw'
import adjectiveSuffixesCSV from '@lib/lang/latin/data/adjective/suffixes.csv?raw'
import adjectiveFootnotesCSV from '@lib/lang/latin/data/adjective/footnotes.csv?raw'
import verbSuffixesCSV from '@lib/lang/latin/data/verb/suffixes.csv?raw'
import verbFootnotesCSV from '@lib/lang/latin/data/verb/footnotes.csv?raw'
import verbFormsCSV from '@lib/lang/latin/data/verb/forms.csv?raw'
import verbFormFootnotesCSV from '@lib/lang/latin/data/verb/form_footnotes.csv?raw'
import verbParticipleSuffixesCSV from '@lib/lang/latin/data/participle/suffixes.csv?raw'
import verbParticipleFormsCSV from '@lib/lang/latin/data/participle/forms.csv?raw'
import verbParticipleFormFootnotesCSV from '@lib/lang/latin/data/participle/form_footnotes.csv?raw'
import verbSupineSuffixesCSV from '@lib/lang/latin/data/supine/suffixes.csv?raw'
import verbSupineFormsCSV from '@lib/lang/latin/data/supine/forms.csv?raw'
import verbSupineFormFootnotesCSV from '@lib/lang/latin/data/supine/form_footnotes.csv?raw'
import gerundiveFormsCSV from '@lib/lang/latin/data/gerundive/forms.csv?raw'
import gerundiveFormFootnotesCSV from '@lib/lang/latin/data/gerundive/form_footnotes.csv?raw'
import adjectiveComparativeSuffixesCSV from '@lib/lang/latin/data/comparative/suffixes.csv?raw'
import adjectiveComparativeFootnotesCSV from '@lib/lang/latin/data/comparative/footnotes.csv?raw'
import adjectiveSuperlativeSuffixesCSV from '@lib/lang/latin/data/superlative/suffixes.csv'
import adjectiveSuperlativeFootnotesCSV from '@lib/lang/latin/data/superlative/footnotes.csv?raw'
