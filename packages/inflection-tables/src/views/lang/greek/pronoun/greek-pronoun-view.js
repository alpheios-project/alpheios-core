import { Constants, Feature, Inflection, Homonym, LanguageModelFactory as LMF } from '@alpheios-core/data-models'
...
export default class GreekPronounView extends GreekView {
  ...
  static matchFilter (languageID, inflections, inflectionData) {
    ...
    if (checkLang && inflections.some(i => i[Feature.types.part] && i[Feature.types.part].value === this.mainPartOfSpeech)) {
