import { Feature, Inflection, Homonym, LanguageModelFactory as LMF, Constants } from '@alpheios-core/data-models'
...
export default class View {
  ...
  static matchFilter (languageID, inflections) {
    ...
    const res = (checkLang && inflections.some(i => i[Feature.types.part] && i[Feature.types.part].value === this.mainPartOfSpeech))
    return res
  }
