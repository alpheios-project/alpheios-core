...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return LanguageDataset; });
/* unused harmony export LanguageData */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return Suffix; });
/* unused harmony export Footnote */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return MatchData; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return SelectedWord; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return WordData; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_styles__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_lang_latin_latin__ = __webpack_require__(3);
        ...
        for (const featureValue of group.groupFeatureType.getOrderedFeatures(ancestorFeatures)) {
            ...
            if (currentLevel < this.features.length - 1) {
                ...
                if (selectedSuffixes.length > 0) {
                    ...
                    selectedSuffixes = __WEBPACK_IMPORTED_MODULE_0__lib_lib__["h" /* Suffix */].combine(selectedSuffixes);
                }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return parts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return numbers; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return types; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return conjugations; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return tenses; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return voices; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return moods; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return persons; });
/* unused harmony export dataSet */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_noun_suffixes_csv__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_noun_footnotes_csv__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_adjective_suffixes_csv__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__data_adjective_footnotes_csv__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_verb_suffixes_csv__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__data_verb_footnotes_csv__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_papaparse__ = __webpack_require__(4);
...
const language = __WEBPACK_IMPORTED_MODULE_0__lib_js__["j" /* languages */].latin;
// Create a language data set that will keep all language-related information
let dataSet = new __WEBPACK_IMPORTED_MODULE_0__lib_js__["e" /* LanguageDataset */](language);
...
const parts = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].part, ['noun', 'adjective', 'verb']);
const numbers = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].number, ['singular', 'plural']);
numbers.addImporter(importerName)
    .map('singular', numbers.singular)
    .map('plural', numbers.plural);
const cases = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].grmCase, ['nominative', 'genitive', 'dative', 'accusative', 'ablative', 'locative', 'vocative']);
...
const declensions = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].declension, ['first', 'second', 'third', 'fourth', 'fifth']);
...
const genders = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].gender, ['masculine', 'feminine', 'neuter']);
...
const types = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].type, ['regular', 'irregular']);
types.addImporter(importerName)
    .map('regular', types.regular)
    .map('irregular', types.irregular);
const conjugations = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].conjugation, ['first', 'second', 'third', 'fourth']);
...
const tenses = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].tense, ['present', 'imperfect', 'future', 'perfect', 'pluperfect', 'future perfect']);
...
const voices = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].voice, ['passive', 'active']);
voices.addImporter(importerName)
    .map('passive', voices.passive)
    .map('active', voices.active);
const moods = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].mood, ['indicative', 'subjunctive']);
moods.addImporter(importerName)
    .map('indicative', moods.indicative)
    .map('subjunctive', moods.subjunctive);
const persons = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].person, ['first', 'second', 'third']);
persons.addImporter(importerName)
    .map('1st', persons.first)
    .map('2nd', persons.second)
    .map('3rd', persons.third);
const footnotes = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].footnote, []);
...
dataSet.matcher = function(inflections, suffix) {
    ...
    let obligatoryMatches = [__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].part];

    // Any of those features must match between an inflection and an ending
    let optionalMatches = [__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].grmCase, __WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].declension, __WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].gender, __WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].number];
     ...
     */
    for (let inflection of inflections) {
        let matchData = new __WEBPACK_IMPORTED_MODULE_0__lib_js__["f" /* MatchData */](); // Create a match profile
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content_process__ = __webpack_require__(6);


// load options, then render
var contentProcess = new __WEBPACK_IMPORTED_MODULE_0__content_process__["a" /* Process */]();
contentProcess.loadData().then(function () {
    contentProcess.status = __WEBPACK_IMPORTED_MODULE_0__content_process__["a" /* Process */].statuses.ACTIVE;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__presenter_presenter__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_message__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__panel__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_options__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__templates_symbols_htmlf__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__templates_page_controls_htmlf__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__templates_panel_htmlf__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__templates_options_htmlf__ = __webpack_require__(42);
...
var Process = function () {
    function Process() {
        ...
        this.messagingService = new __WEBPACK_IMPORTED_MODULE_2__lib_message__["b" /* MessagingService */]();
    }
    ...
    _createClass(Process, [{
        ...
        value: function messageListener(message, sender) {
            ...
            if (!message.type) {
            ...
            } else if (message.type === __WEBPACK_IMPORTED_MODULE_2__lib_message__["a" /* Message */].types.ACTIVATE_REQUEST) {
                // Send a status response
                console.log("Activate request received. Sending a response back.");
                if (!this.isActive) {
                    this.reactivate();
                }
                this.messagingService.sendResponseToBg(new __WEBPACK_IMPORTED_MODULE_2__lib_message__["c" /* StatusResponse */](this.status, message));
            } else if (message.type === __WEBPACK_IMPORTED_MODULE_2__lib_message__["a" /* Message */].types.DEACTIVATE_REQUEST) {
                // Send a status response
                ...
                this.messagingService.sendResponseToBg(new __WEBPACK_IMPORTED_MODULE_2__lib_message__["c" /* StatusResponse */](this.status, message));
            } else if (message.type === __WEBPACK_IMPORTED_MODULE_2__lib_message__["a" /* Message */].types.STATUS_REQUEST) {
                // Send a status response
                console.log("Status request received. Sending a response back.");
                this.messagingService.sendResponseToBg(new __WEBPACK_IMPORTED_MODULE_2__lib_message__["c" /* StatusResponse */](this.status, message));
            } else if (message.type === __WEBPACK_IMPORTED_MODULE_2__lib_message__["a" /* Message */].types.WORD_DATA_RESPONSE) {
                console.log('Message body is:', message.body);

                if (message.status === __WEBPACK_IMPORTED_MODULE_2__lib_message__["a" /* Message */].statuses.DATA_FOUND) {
                    var wordData = __WEBPACK_IMPORTED_MODULE_0__lib_lib__["i" /* WordData */].readObject(message.body);
                    console.log("Word data is: ", wordData);
                    this.panel.clear();
                    this.updateDefinition(wordData);
                    this.updateInflectionTable(wordData);
                    this.panel.open();
                } else if (message.status === __WEBPACK_IMPORTED_MODULE_2__lib_message__["a" /* Message */].statuses.NO_DATA_FOUND) {
                    this.panel.clear();
                ...
                browser.runtime.sendMessage(new __WEBPACK_IMPORTED_MODULE_2__lib_message__["d" /* WordDataRequest */](language, word));
            } else {
        ...
        value: function updateInflectionTable(wordData) {
            this.presenter = new __WEBPACK_IMPORTED_MODULE_1__presenter_presenter__["a" /* default */](this.panel.inflTableContainer, this.panel.viewSelectorContainer, this.panel.localeSwitcherContainer, wordData, this.options.items.locale.currentValue).render();
        }
    }, {
        key: "renderOptions",
        ...
        key: "requestWordData",
        value: function requestWordData(language, word) {
            browser.runtime.sendMessage(new __WEBPACK_IMPORTED_MODULE_2__lib_message__["d" /* WordDataRequest */](language, word));
        }
    }, {
        key: "getSelectedText",
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__l10n_l10n_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_view__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_latin__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_greek__ = __webpack_require__(28);
/**
...
class Presenter {
    ...
    getViews(wordData) {
        ...
        for (let view of this.views) {
            if (wordData.language === view.language && wordData[__WEBPACK_IMPORTED_MODULE_0__lib_lib__["k" /* types */].part].includes(view.partOfSpeech)) {
                views.push(view);
            }
        }
        return views;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__locale_en_us_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__locale_en_gb_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_intl_messageformat__ = __webpack_require__(11);
...
var IntlMessageFormat = __webpack_require__(12)['default'];
...
var src$core$$ = __webpack_require__(13), src$en$$ = __webpack_require__(18);
...
var src$utils$$ = __webpack_require__(2), src$es5$$ = __webpack_require__(14), src$compiler$$ = __webpack_require__(15), intl$messageformat$parser$$ = __webpack_require__(16);
...
exports = module.exports = __webpack_require__(17)['default'];
exports['default'] = exports;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_view__ = __webpack_require__(1);
...
class LatinView extends __WEBPACK_IMPORTED_MODULE_2__lib_view__["c" /* View */] {
    constructor() {
        super();
        this.language = __WEBPACK_IMPORTED_MODULE_0__lib_lib__["j" /* languages */].latin;
         ...
         */
        this.features = {
            numbers: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], 'Number'),
            ...
            declensions: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["c" /* declensions */], 'Declension'),
            genders: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["d" /* genders */], 'Gender'),
            types: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["j" /* types */], 'Type')
        };
    }
    ...
    createTable() {
        ...
        features.columns = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["c" /* declensions */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["d" /* genders */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["j" /* types */]];
        features.rows = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["a" /* cases */]];
        features.columnRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["a" /* cases */]];
        features.fullWidthRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */]];
    }
}
...
class NounView extends LatinView {
    constructor() {
        ...
        this.partOfSpeech = __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["g" /* parts */].noun.value;

        // Features that are different from base class values
        this.features.genders = new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["d" /* genders */], 'Gender',
            [[__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["d" /* genders */].masculine, __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["d" /* genders */].feminine], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["d" /* genders */].neuter]);
...
class AdjectiveView extends LatinView {
    constructor() {
        ...
        this.partOfSpeech = __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["g" /* parts */].adjective.value;

        // Features that are different from base class values
        this.features.declensions = new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["c" /* declensions */], 'Declension',
            [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["c" /* declensions */].first, __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["c" /* declensions */].second, __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["c" /* declensions */].third]);
...
class VerbView extends LatinView {
    constructor() {
        super();
        this.partOfSpeech = __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["g" /* parts */].verb.value;

        this.features = {
            tenses: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */], 'Tenses'),
            numbers: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], 'Number'),
            persons: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */], 'Person'),
            voices: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["k" /* voices */], 'Voice'),
            ...
            moods: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["e" /* moods */], 'Mood')
        };
    }
}
...
class VoiceConjugationMoodView extends VerbView {
    ...
    createTable() {
        ...
        let features = this.table.features;
        features.columns = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["k" /* voices */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["b" /* conjugations */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["e" /* moods */]];
        features.rows = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.columnRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.fullWidthRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */]];
    }
}
...
class VoiceMoodConjugationView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_2__lib_view__["b" /* Table */]([this.features.voices, this.features.moods, this.features.conjugations,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["k" /* voices */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["e" /* moods */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["b" /* conjugations */]];
        features.rows = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.columnRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.fullWidthRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */]];
    }
...
class ConjugationVoiceMoodView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_2__lib_view__["b" /* Table */]([this.features.conjugations, this.features.voices, this.features.moods,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["b" /* conjugations */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["k" /* voices */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["e" /* moods */]];
        features.rows = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.columnRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.fullWidthRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */]];
    }
...
class ConjugationMoodVoiceView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_2__lib_view__["b" /* Table */]([this.features.conjugations, this.features.moods, this.features.voices,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["b" /* conjugations */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["e" /* moods */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["k" /* voices */]];
        features.rows = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.columnRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.fullWidthRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */]];
    }
...
class MoodVoiceConjugationView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_2__lib_view__["b" /* Table */]([this.features.moods, this.features.voices, this.features.conjugations,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["e" /* moods */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["k" /* voices */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["b" /* conjugations */]];
        features.rows = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.columnRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.fullWidthRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */]];
    }
...
class MoodConjugationVoiceView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_2__lib_view__["b" /* Table */]([this.features.moods, this.features.conjugations, this.features.voices,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["e" /* moods */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["b" /* conjugations */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["k" /* voices */]];
        features.rows = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.columnRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["f" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["h" /* persons */]];
        features.fullWidthRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_latin_latin__["i" /* tenses */]];
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_view__ = __webpack_require__(1);
...
class GreekView extends __WEBPACK_IMPORTED_MODULE_2__lib_view__["c" /* View */] {
    constructor() {
        super();
        this.language = __WEBPACK_IMPORTED_MODULE_0__lib_lib__["j" /* languages */].greek;
         ...
         */
        this.features = {
            numbers: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["d" /* numbers */], 'Number'),
            ...
            declensions: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["b" /* declensions */], 'Declension'),
            genders: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */], 'Gender'),
            types: new __WEBPACK_IMPORTED_MODULE_2__lib_view__["a" /* GroupFeatureType */](__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["f" /* types */], 'Type')
        };
    }
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_2__lib_view__["b" /* Table */]([this.features.declensions, this.features.genders,
            this.features.types, this.features.numbers, this.features.cases]);
        let features = this.table.features;
        features.columns = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["b" /* declensions */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["f" /* types */]];
        features.rows = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["d" /* numbers */], __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["a" /* cases */]];
        features.columnRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["a" /* cases */]];
        features.fullWidthRowTitles = [__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["d" /* numbers */]];
    }
}
...
class NounView extends GreekView {
    constructor() {
        ...
        this.name = 'noun declension';
        this.title = 'Noun declension';
        this.partOfSpeech = __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["e" /* parts */].noun.value;

        this.features.genders.getOrderedValues = function getOrderedValues(ancestorFeatures) {
            if (ancestorFeatures) {
                if (ancestorFeatures[0].value === __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["b" /* declensions */].second.value ||
                    ancestorFeatures[0].value === __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["b" /* declensions */].third.value) {
                    return [[__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].masculine.value, __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].feminine.value], __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].neuter.value];
                }
            }
            return [__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].masculine.value, __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].feminine.value, __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].neuter.value];
        };
...
class NounViewSimplified extends NounView {
    constructor() {
        ...
        this.features.genders.getOrderedValues = function getOrderedValues(ancestorFeatures) {
            if (ancestorFeatures) {
                ...
                if (ancestorFeatures[0].value === __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["b" /* declensions */].third.value) {
                    return [[__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].masculine.value, __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].feminine.value, __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].neuter.value]];
                }
            }
            return [__WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].masculine.value, __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].feminine.value, __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__["c" /* genders */].neuter.value];
    ...
    static suffixCellFilter(suffix) {
        return suffix.extendedLangData[__WEBPACK_IMPORTED_MODULE_0__lib_lib__["j" /* languages */].greek].primary;
    }
}
...
"use strict";
/* unused harmony export language */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return parts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return numbers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return cases; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return declensions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return genders; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return types; });
/* unused harmony export dataSet */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_noun_suffixes_csv__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_noun_suffixes_csv___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__data_noun_suffixes_csv__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_noun_footnotes_csv__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_noun_footnotes_csv___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__data_noun_footnotes_csv__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_papaparse__ = __webpack_require__(4);
...
// A language of this module
const language = __WEBPACK_IMPORTED_MODULE_0__lib_js__["j" /* languages */].greek;
// Create a language data set that will keep all language-related information
let dataSet = new __WEBPACK_IMPORTED_MODULE_0__lib_js__["e" /* LanguageDataset */](language);
...
const importerName = 'csv';
const parts = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].part, ['noun', 'adjective', 'verb']);
const numbers = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].number, ['singular', 'dual', 'plural']);
numbers.addImporter(importerName)
    .map('singular', numbers.singular)
    .map('dual', numbers.dual)
    .map('plural', numbers.plural);
const cases = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].grmCase, ['nominative', 'genitive', 'dative', 'accusative', 'vocative']);
cases.addImporter(importerName)
    .map('nominative', cases.nominative)
    .map('genitive', cases.genitive)
    .map('dative', cases.dative)
    .map('accusative', cases.accusative)
    .map('vocative', cases.vocative);
const declensions = dataSet.defineFeatureType(__WEBPACK_IMPORTED_MODULE_0__lib_js__["k" /* types */].declension, ['first', 'second', 'third']);
declensions.addImporter(importerName)
    .map('1st', declensions.first)
    .map('2nd', declensions.second)
    .map('3rd', declensions.third);
...
dataSet.addSuffixes = function(partOfSpeech, data) {
    ...
    for (let i = 1; i < data.length; i++) {
        ...
        let extendedLangData = {
            [__WEBPACK_IMPORTED_MODULE_0__lib_js__["j" /* languages */].greek]: extendedGreekData
        };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return MessagingService; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return WordDataRequest; });
/* unused harmony export WordDataResponse */
/* unused harmony export StatusRequest */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return StatusResponse; });
/* unused harmony export ActivateRequest */
/* unused harmony export DeactivateRequest */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uuid_v1__ = __webpack_require__(33);
...
class WordDataRequest extends RequestMessage {
    constructor(language, word) {
        ...
        this.body = new __WEBPACK_IMPORTED_MODULE_0__lib_lib__["g" /* SelectedWord */](language, word);
    }
}
